...
static void GlfwGetMousePos(GLFWwindow *window, double *xpos, double *ypos)
{
	glfwGetCursorPos(window, xpos, ypos);
}

// Função de callback de mouse - só pode ter uma instância (deve ser estática se
// estiver dentro de uma classe) - É chamada sempre que um botão do mouse for pressionado
...
static void mouse_button_callback(GLFWwindow *window, int button, int action, int mods)
{
	...
	{
		double xpos, ypos;
		GlfwGetMousePos(window, &xpos, &ypos);
		Triangle(&xpos, &ypos);
		numClicks++;
	}
...
static void Triangle(double *xpos, double *ypos)
{
	vector<double> positionClick;

	positionClick.push_back(*xpos);
	positionClick.push_back(*ypos);
};
...
// criar triângulo com clique do mouse
void createTriangleMouse() {
...
struct triangle{
	...
	depois do vector tenho que chamando os vaos

	posso criar os o setup com o setup com os dados que vierem do vector, depois crio o triangulo com o vector de triangulos
*/